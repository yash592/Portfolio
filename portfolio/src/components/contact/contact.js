...
const Contact = () => (
  ...
  <h1>Get in touch</h1>
  <h4>I would love to hear from you so please get in touch</h4>
    <div class="icons">
      ...
      <a href="https://www.facebook.com/YashRajgor" target="_blank"><img className="social" src = "https://cdn3.iconfinder.com/data/icons/free-social-icons/67/facebook_circle_gray-128.png" /></a>
    </div>
