...
const About = () => (
  <div className = "about">
        <h6>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
            ...
            <div class="social-icons"><a href="#"><i class="icon ion-social-github-outline"></i></a><a href="#"><i class="icon ion-social-linkedin-outline"></i></a><a href="#"><i class="icon ion-ios-email-outline"></i></a><a href="#"><i class="icon ion-social-facebook-outline"></i></a></div>
    </div>
)
